...
def build_leave(handle: str) -> bytes:
    ...
    # Das f am Rückgabewert steht für 'formated String' und ermöglicht es, Variablen direkt in den String einzufügen.
    return f"LEAVE {handle}\n".encode('utf-8')

def build_who() -> bytes:
    """Erzeugt eine WHO-Nachricht."""
   # Das b vor dem String kennzeichnet, dass es sich um Bytes handelt. Hier werden keine Variablen 
    return b"WHO\n"
